...
void AuthWebServer::cssfunction(HttpRequest* req, HttpResponse* resp)
{
  ...
  ret<<".resetring i { background-image: url(data:,); width: 10px; height: 10px; margin-right: 2px; display: inline-block; background-repeat: no-repeat; }"<<endl;
  ret<<".resetring:hover i { background-image: url(data:,);}"<<endl;
